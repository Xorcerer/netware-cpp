#############################################################################
# Makefile for building: libcamp
# Generated by qmake (2.01a) (Qt 4.8.4) on: Wed Sep 18 14:11:15 2013
# Project:  libcamp.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile libcamp.pro
#############################################################################
...
INCPATH       = -I/usr/local/Cellar/qt/4.8.4/mkspecs/unsupported/macx-clang -I. -I/usr/local/include
LINK          = clang++
LFLAGS        = -headerpad_max_install_names -arch x86_64
LIBS          = $(SUBLIBS)  -L/usr/local/lib/ -lprotobuf 
AR            = ar cq
RANLIB        = ranlib -s
...
Makefile: libcamp.pro  /usr/local/Cellar/qt/4.8.4/mkspecs/unsupported/macx-clang/qmake.conf /usr/local/Cellar/qt/4.8.4/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.4/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.4/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.4/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.4/mkspecs/common/clang.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/libcamp1.0.0 || $(MKDIR) .tmp/libcamp1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/libcamp1.0.0/ && (cd `dirname .tmp/libcamp1.0.0` && $(TAR) libcamp1.0.0.tar libcamp1.0.0 && $(COMPRESS) libcamp1.0.0.tar) && $(MOVE) `dirname .tmp/libcamp1.0.0`/libcamp1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/libcamp1.0.0
...
campmiddleware.o: campmiddleware.cpp campmiddleware.h \
		config.h \
		serializer.h \
		message_ids.h \
		protos/player.pb.h \
		...
		thread.h \
		socket_utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o campmiddleware.o campmiddleware.cpp

thread.o: thread.cpp thread.h \
		socket_utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o thread.o thread.cpp

player.pb.o: protos/player.pb.cc protos/player.pb.h \
		protos/common.pb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o player.pb.o protos/player.pb.cc

common.pb.o: protos/common.pb.cc protos/common.pb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o common.pb.o protos/common.pb.cc
